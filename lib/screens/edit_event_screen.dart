  ...
  Future<void> _submitForm() async {
    ...
    if (_selectedDate == null ||
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Mohon lengkapi tanggal dan waktu (Mulai & Selesai)'),
        ),
      );
      return;
    }
    ...
    try {
      ...
      await authService
          .init(); // <--- INI PERBAIKANNYA (Wajib init dulu sebelum getToken)
      ...
      if (token != null) {
        ...
        if (success) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text(eventProvider.errorMessage ?? 'Gagal update'),
